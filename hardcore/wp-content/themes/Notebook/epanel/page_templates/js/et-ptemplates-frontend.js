...
jQuery(document).ready(function() {
	jQuery("a[class*=fancybox]").fancybox({
		...
		'centerOnScroll'	: true,
		'padding'           : 0,
		'beforeShow'        : function(){$('#fancybox-content').css('border-width', '0');}
	});
	...
	$et_inputs.each( function(index, domEle){
		var $et_hidden_label = jQuery(domEle).siblings('label.et_hidden'),
			et_field_value = $et_hidden_label.attr( 'for' );

		form_default_values[et_field_value] = $et_hidden_label.text();
	} );
