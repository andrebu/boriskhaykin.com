		...
		<div id="top-header-pattern">
			<div class="container clearfix">
				<a href="<?php bloginfo('url'); ?>">
					...
					<img src="<?php echo esc_url($logo); ?>" alt="InReview Logo" id="logo"/>
				</a>
				...
				if ($primaryNav == '') { ?>
					<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
						<?php if (get_option('inreview_home_link') == 'on') { ?>
							<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php esc_html_e('Home','InReview') ?></a></li>
						<?php }; ?>
